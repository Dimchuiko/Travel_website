  ...
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
        ...
        <div className='flex flex-col h-full justify-center'>
            <h3 className='text-5xl md:text-6xl font bold'>Plan Your Nex Trip</h3>
            <p className='text-2xl py-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias architecto voluptates aliquid. Cumque odit unde esse libero, eius amet cupiditate!</p>
            <p className='pb-6'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ex quod tenetur praesentium aut ea iure culpa! Dolores explicabo possimus magnam pariatur inventore eveniet deleniti! Officia et perferendis reprehenderit nostrum enim adipisci numquam accusamus velit ad beatae? Unde, minima fugit praesentium veniam at magni porro? Deleniti minima cumque dolores mollitia nam!</p>
        <div>
